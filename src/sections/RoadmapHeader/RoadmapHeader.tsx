...
import { logo, parachutes1, planetBg } from "../../assets";
...
const RoadmapHeader = () => {
  ...
  return (
    <Section
      id="roadmap"
      className="pt-40 pb-10 flex flex-col md:flex-row justify-center flex-center xl:px-0 h-290"
    ...
    >
      ...
      {/* Parachutes1 */}
      <div
        className="absolute -top-480 left-280 pointer-events-none"
